...
\begin{figure}[p]
  ...
  \begin{minipage}{.45\textwidth}
    \includestandalone[width=\textwidth]{figures/timemkn}
    \caption{Time to calculate one probability using different
      $n$-gram models.}
  \end{minipage}
  \hspace{.02\textwidth}
  \begin{minipage}{.45\textwidth}
  ...
  \begin{minipage}{0.45\textwidth}
    ...
    \caption{Calculation time for top-$k$ prediction using $5$-gram models.}
  \end{minipage}
  ...
  \begin{minipage}{0.45\textwidth}
    ...
    \caption{Time to calculate NKSS using different $n$-gram models.}
  \end{minipage}
  \hspace{.02\textwidth}
  \begin{minipage}{0.45\textwidth}
