...
\begin{draft}
$w_1 \ldots w_n$ does not mean that $w_1$ is the first word of a given sentence.
We rather interpret it as the starting point of an arbitrary subsequence of the
sentence, to simplify notation.
\end{draft}
