...
%The concern of this thesis is solving noisy channel type queries based on
%statistical language model probabilities, by employing top-$k$ joining
%techniques, in order to avoid having to calculate probabilities for all
%arguments.
%To avoid having to calculate probabilities for all arguments top-$k$ joining
